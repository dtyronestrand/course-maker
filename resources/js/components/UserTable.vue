            ...
            if (isThisRowEditing) {
                return h('div', { class: 'flex gap-2 items-center' }, [
                    h(
                        'button',
                        {
                            class: 'rounded bg-green-500 px-3 py-1 text-xs text-white hover:bg-green-600 focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 outline-none',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                saveEdit(user.id);
                            },
                    ...
                    h(
                        'button',
                        {
                            class: 'rounded bg-red-500 px-3 py-1 text-xs text-white hover:bg-red-600 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 outline-none',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                cancelEdit();
                            },
                    ...
                    h(
                        'button',
                        {
                            ...
                            class: 'focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 outline-none rounded',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                deleteUser(user.id);
                            },
                ...
                return h('div', { class: 'flex gap-3 items-center' }, [
                    h(
                        'button',
                        {
                            ...
                            class: 'opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity cursor-pointer focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 outline-none rounded',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                startEdit(user);
                            },
