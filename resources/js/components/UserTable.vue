            ...
            if (isThisRowEditing) {
                return h('div', { class: 'flex gap-2 items-center' }, [
                    ...
                    h(
                        'button',
                        {
                            class: 'focus-visible:ring-2 focus-visible:ring-ring outline-none ml-1',
                ...
                return h('div', { class: 'flex gap-3 items-center' }, [
                    h(
                        'button',
                        {
                            class: 'opacity-0 group-hover:opacity-100 focus:opacity-100 focus-visible:ring-2 focus-visible:ring-ring outline-none transition-opacity',
