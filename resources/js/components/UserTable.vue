        ...
        return h("div", { class: "flex gap-2 items-center" }, [
          ...
          h(
            "button",
            {
              ...
              class:
                "rounded focus-visible:ring-2 focus-visible:ring-red-400 focus:outline-none ml-1",
              onClick: (e: Event) => {
                e.stopPropagation();
                deleteUser(user.id);
              },
          ...
          [
            h(
              "button",
              {
                ...
                class:
                  "rounded opacity-0 group-hover:opacity-100 focus:opacity-100 focus-visible:ring-2 focus-visible:ring-amber-400 focus:outline-none transition-opacity",
                onClick: (e: Event) => {
                  e.stopPropagation();
                  startEdit(user);
                },
