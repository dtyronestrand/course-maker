            ...
            if (isThisRowEditing) {
                return h('div', { class: 'flex gap-2 items-center' }, [
                    h(
                        'button',
                        {
                            class: 'rounded bg-green-500 px-3 py-1 text-xs text-white hover:bg-green-600 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-1',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                saveEdit(user.id);
                            },
                    ...
                    h(
                        'button',
                        {
                            class: 'rounded bg-red-500 px-3 py-1 text-xs text-white hover:bg-red-600 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-1',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                cancelEdit();
                            },
                    ...
                    h(
                        'button',
                        {
                            class: 'rounded focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-1 focus-visible:ring-red-500',
                ...
                return h('div', { class: 'flex gap-3 items-center' }, [
                    h(
                        'button',
                        {
                            class: 'rounded focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-1 focus-visible:ring-amber-500 focus:opacity-100 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer text-amber-500 hover:text-amber-700',
