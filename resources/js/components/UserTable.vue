                ...
                return h('div', { class: 'flex gap-2 items-center' }, [
                    ...
                    h(
                        'button',
                        {
                            ...
                            class: 'cursor-pointer ml-1 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none rounded-md p-1',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                deleteUser(user.id);
                            },
                ...
                return h('div', { class: 'flex gap-3 items-center' }, [
                    h(
                        'button',
                        {
                            ...
                            class: 'opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none rounded-md p-1',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                startEdit(user);
                            },
