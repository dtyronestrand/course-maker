            ...
            if (isThisRowEditing) {
                return h('div', { class: 'flex gap-2 items-center' }, [
                    ...
                    h(
                        'button',
                        {
                            class: 'text-red-500 cursor-pointer hover:text-red-700 ml-1 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none rounded',
                ...
                return h('div', { class: 'flex gap-3 items-center' }, [
                    h(
                        'button',
                        {
                            class: 'opacity-0 focus:opacity-100 group-hover:opacity-100 transition-opacity cursor-pointer text-amber-500 hover:text-amber-700 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none rounded',
