            ...
            if (isThisRowEditing) {
                return h('div', { class: 'flex gap-2 items-center' }, [
                    ...
                    h(
                        'button',
                        {
                            class: 'ml-1 rounded text-red-500 hover:text-red-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500',
                        ...
                        [h(Trash2, { class: 'h-4 w-4 pointer-events-none' })],
                    ),
                ]);
            } else {
                return h('div', { class: 'flex gap-3 items-center focus-within:opacity-100' }, [
                    h(
                        'button',
                        {
                            class: 'rounded text-amber-500 opacity-0 transition-opacity hover:text-amber-700 group-hover:opacity-100 focus:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500',
                        ...
                        [h(Pencil, { class: 'h-6 w-6 pointer-events-none' })],
                    ),
                ]);
            }
        },
