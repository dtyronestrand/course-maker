        ...
        return h("div", { class: "flex gap-2 items-center" }, [
          ...
          h(
            "button",
            {
              ...
              class:
                "ml-1 rounded focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none",
              onClick: (e: Event) => {
                e.stopPropagation();
                deleteUser(user.id);
              },
        ...
        return h("div", { class: "flex gap-3 items-center" }, [
          h(
            "button",
            {
              ...
              class:
                "rounded focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity",
              onClick: (e: Event) => {
                e.stopPropagation();
                startEdit(user);
              },
            ...
            [
              h(Pencil, {
                class:
                  "w-6 h-6 cursor-pointer text-amber-500 hover:text-amber-700",
              }),
            ],
          ),
        ]);
