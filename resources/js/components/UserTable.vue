        ...
        return h("div", { class: "flex gap-2 items-center" }, [
          ...
          h(
            "button",
            {
              ...
              class:
                "ml-1 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 outline-none rounded",
              onClick: (e: Event) => {
                e.stopPropagation();
                deleteUser(user.id);
              },
        ...
        return h("div", { class: "flex gap-3 items-center" }, [
          h(
            "button",
            {
              ...
              class:
                "opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 outline-none rounded",
              onClick: (e: Event) => {
                e.stopPropagation();
                startEdit(user);
              },
