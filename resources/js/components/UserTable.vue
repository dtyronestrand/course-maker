                ...
                return h('div', { class: 'flex gap-3 items-center' }, [
                    h(
                        'button',
                        {
                            ...
                            class: 'opacity-0 group-hover:opacity-100 focus:opacity-100 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none transition-opacity rounded',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                startEdit(user);
                            },
