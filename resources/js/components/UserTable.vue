                ...
                return h('div', { class: 'flex gap-2 items-center' }, [
                    ...
                    h(
                        'button',
                        {
                            ...
                            class: 'focus-visible:ring-2 focus-visible:outline-hidden',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                deleteUser(user.id);
                            },
                ...
                return h('div', { class: 'flex gap-3 items-center focus-within:opacity-100' }, [
                    h(
                        'button',
                        {
                            ...
                            class: 'opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-hidden transition-opacity cursor-pointer',
                            onClick: (e: Event) => {
                                e.stopPropagation();
                                startEdit(user);
                            },
