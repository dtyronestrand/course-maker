      ...
      if (isThisRowEditing) {
        return h("div", { class: "flex gap-2 items-center" }, [
          ...
          h(
            ...
            {
              class:
                "focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded ml-1",
        ...
        return h("div", { class: "flex gap-3 items-center" }, [
          h(
            ...
            {
              class:
                "opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 rounded",
