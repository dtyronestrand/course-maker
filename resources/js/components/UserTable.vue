      ...
      if (isThisRowEditing) {
        return h("div", { class: "flex gap-2 items-center" }, [
          h(
            ...
            {
              class:
                "rounded bg-green-500 px-3 py-1 text-xs text-white hover:bg-green-600",
              onClick: (e: Event) => {
                e.stopPropagation();
                saveEdit(user.id);
              },
          ...
          h(
            ...
            {
              class:
                "rounded bg-red-500 px-3 py-1 text-xs text-white hover:bg-red-600",
              onClick: (e: Event) => {
                e.stopPropagation();
                cancelEdit();
              },
          ...
          h(
            "button",
            {
              ...
              class:
                "rounded focus-visible:ring-2 focus-visible:ring-red-500 outline-none",
              onClick: (e: Event) => {
                e.stopPropagation();
                deleteUser(user.id);
              },
            ...
            [
              h(Trash2, {
                class:
                  "w-4 h-4 text-red-500 cursor-pointer hover:text-red-700 ml-1",
              }),
            ],
          ),
        ]);
        ...
        return h("div", { class: "flex gap-3 items-center" }, [
          h(
            "button",
            {
              ...
              class:
                "rounded focus-visible:ring-2 focus-visible:ring-amber-500 outline-none opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity",
              onClick: (e: Event) => {
                e.stopPropagation();
                startEdit(user);
              },
