<template>
  <ul class="flex flex-row gap-4">
    <li
      class="course-card glass w-[25%] flex-col flex-wrap border border-primary! p-4 flex cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
