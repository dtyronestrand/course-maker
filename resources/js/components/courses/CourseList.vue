<template>
    <ul class="flex flex-row gap-4">
        <li
            class="course-card glass flex w-[25%] cursor-pointer flex-col flex-wrap border border-primary! p-4 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
            role="button"
            tabindex="0"
