    ...
    >
        ...
        >
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-3xl font-bold text-center flex-1">Edit</h1>
                <button
                    @click="$emit('modal-close')"
                    class="text-primary-content hover:text-error focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 outline-none p-1 rounded-sm"
