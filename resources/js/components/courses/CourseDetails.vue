<template>
  ...
  >
    <div
      class="glass pointer-events-auto max-h-screen w-full max-w-xl overflow-y-auto rounded-lg border border-primary p-6 shadow-lg shadow-primary relative"
      ref="target"
    >
      <div class="flex justify-between items-center mb-4">
        <h1 class="text-3xl font-bold flex-1 text-center">Edit</h1>
        <button
          type="button"
          class="cursor-pointer text-xl hover:opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded"
      ...
      >
        ...
        />
        <div class="mb-4">
          <label for="notes" class="text-base-content block text-sm font-medium"
            >Notes</label
          >
          <textarea
        ...
        <div class="mb-4">
          <label for="cycle" class="text-base-content block text-sm font-medium"
