<template>
    ...
    >
        <div
            v-if="props.isOpen"
            class="bg-surface-container mx-auto max-w-3xl rounded-lg border border-primary p-4 shadow-sm shadow-primary"
        >
            <div class="mb-4 flex items-center justify-between">
                ...
                <button
                    ...
                    class="rounded-md p-1 hover:bg-primary/20 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:outline-none"
