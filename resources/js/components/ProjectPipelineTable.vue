<template>
    <DebouncedInput
        ...
        class="bg-transparent my-4 w-max rounded-md border !border-primary px-4 py-2 font-bold"
    />
...
const data = computed(() =>
    props.courses.map((course) => {
        const { id: _id, ...rest } = course; // eslint-disable-line @typescript-eslint/no-unused-vars
