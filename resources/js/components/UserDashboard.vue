                ...
                >
                    ...
                    <div class="mt-4">
                        <ul>
                            ...
                            >
                                <label
                                    class="hover:bg-base-200 flex cursor-pointer flex-row items-center justify-between rounded-md px-4 py-2 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
                                >
