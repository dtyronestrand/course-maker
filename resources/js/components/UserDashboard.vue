        ...
        >
          ...
          <div class="mt-4">
            <ul>
              ...
              >
                <label
                  class="flex flex-row items-center justify-between px-4 py-2 cursor-pointer w-full hover:bg-base-200/50 rounded transition-colors"
                >
                  {{ deliverable.name }}
                  <input
                    type="checkbox"
                    v-model="deliverable.pivot.is_done"
                    class="focus-visible:ring-2 focus-visible:ring-primary outline-none cursor-pointer"
                  />
                </label>
              </li>
            </ul>
          ...
          <div class="mt-4 flex justify-center flex-row gap-4">
            <button
              class="bg-primary text-[var(--on-primary)] text-sm px-4 py-2 rounded-lg"
            >
              Course Map
            </button>
            <button
              class="bg-secondary text-[var(--on-secondary)] text-sm px-4 py-2 rounded-lg"
            >
              Course Storyboard
            </button>
          </div>
