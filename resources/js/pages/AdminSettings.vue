    ...
    >
      ...
      <div>
        ...
        >
          <div class="flex flex-row flex-nowrap justify-between">
            ...
            <div class="flex space-x-2">
              <button
                aria-label="Edit Development Cycle"
                @click="editCycle(cycle)"
                class="rounded focus-visible:ring-2 focus-visible:ring-amber-400 focus:outline-none"
              >
                <Pencil class="text-amber-500" :size="20" />
              </button>
              <button
                aria-label="Delete Development Cycle"
                @click="deleteCycle(cycle)"
                class="rounded focus-visible:ring-2 focus-visible:ring-red-400 focus:outline-none"
              >
        ...
        <form v-if="addCycle" @submit.prevent class="mt-4 flex flex-col gap-4">
          ...
          <Button @click="addCycle = false" variant="destructive" class="mr-2"
            >Cancel</Button
          >
      ...
      <div>
        ...
        >
          ...
          >
          <Button @click="addDeliverable = false" variant="error" class="mr-2"
            >Cancel</Button
          >
        </form>
      </div>
