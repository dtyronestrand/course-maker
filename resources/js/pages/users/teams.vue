        ...
        >
            ...
            >
                <div v-if="edit !== team.id">
                    <div
                        class="flex flex-row justify-end opacity-0 group-hover:opacity-100 focus-within:opacity-100"
                    >
                        <Pencil
                            role="button"
                            aria-label="Edit team"
                            tabindex="0"
                            class="rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
